...
class AppStore extends Component {
  state = {searchInput: '', activeTabId: 'Social'}
  ...
  getFilteredApps = () => {
    ...
    let filteredApps = appsList.filter(app => app.category === activeTabId)
        ...
        <div className="app-store">
          ...
          <ul className="tabs-list">
            {tabsList.map(eachTab => (
              ...
              >
                <button>{eachTab.displayText}</button>
              </TabItem>
            ))}
          </ul>
